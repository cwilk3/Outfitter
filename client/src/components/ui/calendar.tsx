  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-xl font-semibold px-4",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 bg-transparent p-0 opacity-50 hover:opacity-100 border-none"
        ),
        ...
        head_cell:
          "text-muted-foreground font-medium text-base w-12 h-12 flex items-center justify-center",
        ...
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-12 w-12 p-0 font-normal aria-selected:opacity-100 rounded-full hover:bg-gray-100"
        ),
        ...
        day_range_middle:
          "aria-selected:bg-green-800 aria-selected:text-white rounded-none",
