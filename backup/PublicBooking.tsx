  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {!selectedLocation ? (
          /* Show Locations Grid when no location is selected */
          <>
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {locations.map((location) => (
                  ...
                  >
                    ...
                    <div className="relative h-60 overflow-hidden bg-gradient-to-br from-primary-700 to-gray-900">
          ...
          /* Show Experiences for Selected Location */
          <>
