...
CREATE TABLE "addon_inventory_dates" (
	"id" serial PRIMARY KEY NOT NULL,
...
ALTER TABLE "addon_inventory_dates" ADD CONSTRAINT "addon_inventory_dates_addon_id_experience_addons_id_fk" FOREIGN KEY ("addon_id") REFERENCES "public"."experience_addons"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "bookings" ADD CONSTRAINT "bookings_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customers" ADD CONSTRAINT "customers_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "documents" ADD CONSTRAINT "documents_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "experience_guides" ADD CONSTRAINT "experience_guides_experience_id_experiences_id_fk" FOREIGN KEY ("experience_id") REFERENCES "public"."experiences"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "experience_guides" ADD CONSTRAINT "experience_guides_guide_id_users_id_fk" FOREIGN KEY ("guide_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "experiences" ADD CONSTRAINT "experiences_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "locations" ADD CONSTRAINT "locations_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payments" ADD CONSTRAINT "payments_booking_id_bookings_id_fk" FOREIGN KEY ("booking_id") REFERENCES "public"."bookings"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "payments" ADD CONSTRAINT "payments_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "settings" ADD CONSTRAINT "settings_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_outfitters" ADD CONSTRAINT "user_outfitters_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_outfitters" ADD CONSTRAINT "user_outfitters_outfitter_id_outfitters_id_fk" FOREIGN KEY ("outfitter_id") REFERENCES "public"."outfitters"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
